...
// Page shell got wider (was 800) so content has room to sit off-center
// instead of pinned to a narrow centered column.
const PAGE = { maxWidth: 1200 } as const;

// Two alignment variants for the content block inside a full-width section.
// Left/right alternates per section — the section's own padding/background
// still spans the full width, only the text block shifts.
const BLOCK_L = { maxWidth: 620, marginRight: "auto" } as const;
const BLOCK_R = { maxWidth: 620, marginLeft: "auto" } as const;
  ...
  return (
    <main className="grid-bg" style={{ minHeight: "100vh" }}>
      <div style={{ maxWidth: PAGE.maxWidth, margin: "0 auto" }}>
        ...
        {/* HERO — left */}
        <section style={{ padding: "52px 22px 40px" }}>
          <div style={BLOCK_L}>
            <h1
              style={{
        ...
        {/* PROBLEM — right */}
        <section style={{ padding: "44px 22px", borderTop: "0.5px solid var(--line)" }}>
          <div style={BLOCK_R}>
        ...
        {/* TRUST — right */}
        <section style={{ padding: "40px 22px", borderTop: "0.5px solid var(--line)" }}>
          <div style={{ ...BLOCK_R, maxWidth: 600 }}>
            <div
              style={{
                display: "grid",
        ...
        {/* FINAL — centered on purpose, it's a single closing CTA */}
        <section
          style={{
            padding: "56px 22px",
            textAlign: "center",
